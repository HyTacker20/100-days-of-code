...
class CafeForm(FlaskForm):
    ...
    power_socket_rating = SelectField('Power Socket Rating', choices=[
        ("🔌", "🔌"),
        ("🔌🔌", "🔌🔌"),
        ("🔌🔌🔌", "🔌🔌🔌"),
        ("🔌🔌🔌🔌", "🔌🔌🔌🔌"),
...
@app.route('/add', endpoint=["GET", "POST"])
def add_cafe():
    form = CafeForm()
...
@app.route('/cafes')
def cafes():
    with open("Day 62 - Coffee & Wifi Website/cafe_data.csv", newline='', encoding='utf-8') as csv_file:
